...
3 - Déclarer le type de l'attribut que vous testez avec l'interface ModelGenerator. Créer une méthode de test qui vérifie la non-nullité de votre attribvut. Constatez l'erreur dans la log.

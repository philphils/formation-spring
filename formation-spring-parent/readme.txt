...
4 - Contrôler la dépendance retournée via Spring avec les 2 annotations le permettant vu dans le cours. Vérifier avec un test que vous récupérer le bon bean.
